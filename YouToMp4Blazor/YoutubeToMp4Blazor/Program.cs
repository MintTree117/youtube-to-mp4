...
using YoutubeToMp4Blazor.Components;
using YoutubeToMp4Blazor.Data;
using YoutubeToMp4Blazor.Features.Authentication;
using YoutubeToMp4Blazor.Features.FFmpeg;
using YoutubeToMp4Blazor.Features.Youtube;
...
app.MapRazorComponents<App>()
    ...
    .AddAdditionalAssemblies( typeof( YoutubeToMp4.Client._Imports ).Assembly );
